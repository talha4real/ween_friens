...
<nav className="navbar navbar-expand-md navbar-light" id="banner">
            <div className="container">
                ...
                <a className="navbar-brand" href="#">
                    <img  alt='' className="img-fluid pt-3 logo-img" src={Topleftlogo} />
                </a>
                ...
                <div className="collapse navbar-collapse center-nav" id="collapsibleNavbar">
                    <ul className="navbar-nav ms-auto">
                        <li className="nav-item px-3">
                            <a className="nav-link" href="#">THE COLLECTION</a>
                        </li>
                        <li className="nav-item px-3">
                            <a className="nav-link active" href="#">THE ART</a>
                        </li>
                        <li className="nav-item px-3">
                            <a className="nav-link" href="#">BUY A WEENY</a>
                        </li>
                    </ul>
                    ...
                    <ul className="navbar-nav ms-auto right-nav">
                        ...
                        <li className="nav-item">
                            <a className="nav-link" href="#"><img alt='' className="img-fluid right-logos"
                                    src={MagicEdenLogo} /></a>
                        </li>
                        <li className="nav-item">
                            <a className="nav-link" href="#"><img alt='' className="img-fluid right-logos2"
                                    src={Opensea} /></a>
                        </li>
                        <li className="nav-item">
                            <a className="nav-link" href="#"><img alt='' className="img-fluid right-logos2"
                        ...
                        <li className="nav-item">
                            <a href="#" className="connect-text nav-link">
                                Connect Wallet</a>
                            </li>
        ...
        <section id="about" className="mb-5">
            <div className="about-container">
                <p className="about-text">
                    Ween frens is a special collection of 6,666 hand-drawn INKED and completely reimagined vintage
                    characters inspired by the golden generation of 70's cartoons.
                </p>
                <p className="about-text">
                    The weenies collection is barely scratching
                    the surface of what is coming next.
                </p>
                <p className="about-text">
                    Are you ready take the journey
                    with us ?
                </p>
            </div>
        </section>
...
{/* 
                ...
                <div className="row">
                    ...
                    <div className="col  text-center p-2">
                        ...
                        <p className="plan-text">
                            When Frens is a special collection of 6.666 hand-drawn inked and completely reimagined
                            vintage characters inspired by the golden generation of 70's cartoons.
                        </p>
                    </div>
    ...
    <footer>
        <div className="row upper-footer">
            <div className="col-6 col-xl-4 col-md-5 text-center"><a className="footer-link" href="#">CONTACT US</a></div>
            <div className="col-xl-4 col-md-2 d-none d-md-block"></div>
            <div className="col-6 col-xl-4 col-md-5  text-center"><a className="footer-link" href="#">WORK WITH US</a></div>
        </div>
        <div className="row text-center lower-footer">
            <p className="footer-disclaimer text-white">©️ 2022, WEENFRENS POWERED BY WEB3 DEGENS</p>
        </div>
    </footer>
    </div>
  )
